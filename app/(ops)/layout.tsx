...
import { resolveCapabilities } from "@/lib/portal/capabilities";
import { OpsNav } from "@/components/portal/OpsNav";

export default async function OpsLayout({ children }: { children: React.ReactNode }) {
  // Server-side gate for all of Zone D (in addition to middleware).
  ...
  return (
    <div className="portal-root flex min-h-screen flex-col md:flex-row">
      <OpsNav email={user.email} capabilities={caps} />
